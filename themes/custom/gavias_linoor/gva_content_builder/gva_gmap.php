   ...
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
       ...
       <?php ob_start() ?>
         ...
         <script src="<?php print (base_path() . drupal_get_path('theme', 'gavias_linoor')) ?>/vendor/gmap3.js"></script>
         <script src="<?php print (base_path() . drupal_get_path('theme', 'gavias_linoor')) ?>/vendor/jquery.ui.map.min.js"></script>
