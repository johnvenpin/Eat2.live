...
if(!class_exists('element_gva_image')):
   class element_gva_image{
         ...
         $fields =array(
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'options'   => array( 
                     ''                => t('No Effect'),
                     'effect-image-v1' => t('Effect V1'),
                     'effect-image-v2' => t('Effect V2')
                  )
               ),
               array(
                  'id'     => 'alt',
      ...
      public static function render_content( $attr, $content = null ){
         ...
         ?>
         <?php ob_start() ?>
            <div class="widget gsc-image<?php if(count($class_array) > 0) print (' ' . implode(' ', $class_array)) ?>"  <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <div class="widget-content">
                  <?php if($link){ ?>
                     <a href="<?php print $link ?>" <?php print $target ?>>
                  <?php } ?> 
                    <img src="<?php print $image ?>" alt="<?php print $alt ?>" <?php print $style_image ?> />
                  <?php if($link){print '</a>'; } ?>
               </div>
            </div>    
