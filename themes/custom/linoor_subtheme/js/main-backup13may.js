...
jQuery(document).ready(function ($) {
  ...
  function confirm() {
        ...
        // window.parent.$.magnificPopup.close();// save instance in magnificPopup variable
      }
...
function addBill(id) {
    ...
    var billTotal = 0.0;
      ...
      if (typeof(Storage) !== "undefined") {
        ...
        var x, txt = "";
        var billDisplay = localStorage.getItem("billtotal");

        for (x in billDisplay) {
          txt += billDisplay[x] + " ";
        };
        ...
        // Retrieve
        // document.getElementById("bill").innerHTML = billDisplay;
      } else {
