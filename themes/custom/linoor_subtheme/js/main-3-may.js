  ...
  function eat2liveengine( )
        {
          ...
          var timezoneCorrect = offset * -60 ; // BST for testing purposes
          ...
          var eventStart = unixCountDownDate - now + (durationSeconds * 1000);

          // Time calculations for days, hours, minutes and seconds
          var days = Math.floor(eventEnd / (1000 * 60 * 60 * 24));
          var hours = Math.floor((eventEnd % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
          var minutes = Math.floor((eventEnd % (1000 * 60 * 60)) / (1000 * 60));
          var seconds = Math.floor((eventEnd % (1000 * 60)) / 1000);
          ...
          if (eventEnd < 0) {
              ...
              document.getElementById("status").innerHTML = "Sorry the Eating has finished";
            }
            else {
            // Output the result in an element with id="start-time-countdown"
